...
// Removed unused import (already done)
...
export default function AdminRegisterPage() {
  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    try {
      ...
      const data = await res.json(); // To be typed below, adjust based on API
      console.log("Login successful", data); // Placeholder for success handling
    } catch (error) {
  ...
  return (
    <div className="flex items-center justify-center bg-gray-100 mt-20">
      <form
        ...
        className="flex flex-col items-center justify-center min-h-screen w-full bg-white p-8 rounded shadow-md"
      >
