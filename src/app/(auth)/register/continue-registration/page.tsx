...
export default function ApplicantRegisterPage() {
  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    try {
      ...
      const data = await res.json(); // To be typed if used, adjust based on API
      console.log("Registration successful", data); // Placeholder for success handling
    } catch (error) {
  ...
  const handleFileChange = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    if (file) {
      ...
      // Add file upload logic here (e.g., send to API)
    }
  };
  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-gray-100">
      <form
        ...
        className="flex flex-col items-center justify-center bg-white p-8 w-full rounded shadow-md"
      >
        ...
        <h2 className="dark:text-black text-2xl font-bold mb-1 mx-4">Continue to Skillinq</h2>
        <span className="mb-6 dark:text-black text-xs font-normal mx-9">Let&apos;s help you find your next role</span>
        ...
        <div className="flex flex-row items-center justify-center gap-8 w-2xl">
          <div className="flex flex-col mb-2 gap-3 w-full">
            <label htmlFor="firstName" className="mb-2 mt-6 block font-semibold dark:text-black text-xs">
              First Name
            </label>
            <input
              type="text"
              placeholder="Enter your first name"
              className="mb-4 w-full max-w-xs p-2 border border-gray-400 rounded dark:text-black"
              value={firstName}
              onChange={(e) => setFirstName(e.target.value)}
              required
            />
            <label htmlFor="email" className="mb-2 block font-semibold dark:text-black text-xs">
              Email
            </label>
            <input
              type="email"
              ...
              required
            />
            <label htmlFor="industry" className="mb-2 block font-semibold dark:text-black text-xs">
              Industry
            </label>
          ...
          <div className="flex flex-col gap-3 w-full">
            <label htmlFor="lastName" className="mb-2 mt-6 block font-semibold dark:text-black text-xs">
              Last Name
            </label>
            <input
              type="text"
              ...
              required
            />
            <label htmlFor="password" className="mb-2 block font-semibold dark:text-black text-xs">
              Password
            </label>
            <input
              type="password"
              ...
              required
            />
            <label htmlFor="preferredRole" className="mb-2 block font-semibold dark:text-black text-xs">
              Preferred Role
            </label>
        ...
        <div className="flex flex-col items-center justify-center border-2 w-2xl max-h-full my-10 border-gray-200 border-dashed">
          <div className="flex flex-col items-center justify-center my-8">
            ...
            >
              <svg
                className="my-2 w-[30px] h-[30px] text-gray-800 mb-3 dark:text-white"
                aria-hidden="true"
            ...
            <span className="text-gray-400 text-center text-sm">
              <a href="#" className="text-blue-800 hover:underline" onClick={(e) => { e.preventDefault(); document.getElementById("cvUpload")?.click(); }}>
                Click to upload your CV
              </a>{" "}
              or drag and drop files here<br />PDF, SVG, PNG, JPG or GIF
            </span>
          </div>
        </div>
        ...
        <div className="flex flex-col gap-6 place-items-center">
          ...
          <span className="text-xs dark:text-black font-normal mx-3">
            ...
            <a href="/login" className="text-blue-800 hover:underline">Sign in</a>
          </span>
        </div>
      </form>
    </div>
