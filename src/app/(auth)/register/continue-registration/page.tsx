        ...
        <form onSubmit={handleSubmit} className="flex flex-col items-center justify-center bg-white p-8 w-full rounded shadow-md">
            ...
            <div className="flex flex-row items-center justify-center gap-8 w-2xl">
                <div className="flex flex-col mb-2 gap-3 w-full">
                    <label htmlFor="firstName" className="mb-2 mt-6 block font-semibold dark:text-black text-xs">First Name</label>
                    <input
                    type="text"
                    ...
                    required
                    />
                    <label htmlFor="email" className="mb-2 block font-semibold dark:text-black text-xs">Email</label>
                    <input
                    type="email"
                    placeholder="Enter your email"
                    className="mb-4 w-full max-w-xs p-2 border border-gray-400 dark:border-gray-400 dark:text-gray-700 rounded"
                    value={email}
                    onChange={e => setEmail(e.target.value)}
                    required
                    />
                    <label htmlFor="industry" className="mb-2 block font-semibold dark:text-black text-xs">Industry</label>
                    <div className="mb-2 w-full max-w-xs p-2 border border-gray-400 dark:border-gray-400 rounded">
                        <select
                                id="industry"
                ...
                <div className="flex flex-col gap-3 w-full">
                    <label htmlFor="lastName" className="mb-2 mt-6 block font-semibold dark:text-black text-xs">Last Name</label>
                    <input
                    type="text"
                    ...
                    required
                    />
                    <label htmlFor="password" className="mb-2 block font-semibold dark:text-black text-xs">Password</label>
                    <input
                    type="password"
                    placeholder="********"
                    className="mb-4 w-full max-w-xs p-2 border dark:text-black border-gray-400 rounded"
                    value={password}
                    onChange={e => setPassword(e.target.value)}
                    required
                    />
                    <label htmlFor="preferredRole" className="mb-2 block font-semibold dark:text-black text-xs">Preferred Role</label>
