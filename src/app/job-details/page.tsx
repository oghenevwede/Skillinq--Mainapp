...
import BookmarkIcon from "../components/icons/BookmarkIcon"; // Note: This is used for location in code, but screenshot shows a map icon; replace with MapIcon if available
  ...
  useEffect(() => {
    dispatch(
      setSelectedJob({
        ...
        experience: "$50k-80k/month", // Note: This seems mismatched; screenshot shows this under EXPERIENCE, but requirements mention 3+ years; consider updating to "3+ years"
    ...
    <div className="bg-white min-h-screen text-gray-900 transition-colors duration-300">
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="flex flex-col lg:flex-row items-start lg:items-center justify-between mb-20">
          <div className="flex items-center mb-4 lg:mb-0">
            ...
            <div>
              ...
              <div className="flex items-center text-sm text-gray-500 mt-1">
                <span className="mr-2">at {job.company}</span>
          ...
          <div className="flex space-x-4 w-sm ml-20">
            ...
            <button className="flex items-center justify-center gap-2 bg-blue-800 text-white w-1/2 px-4 py-3 rounded shadow-sm hover:bg-blue-700 transition-colors">
              <span>Apply</span>
              <ArrowRightIcon className="ml-2 h-4 w-4" />
            </button>
          </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="space-y-8">
            <div className="flex flex-row items-center justify-center py-4 gap-12 bg-white border-3 border-blue-50 rounded-lg w-md">
              ...
              <div className="p-4">
                <h2 className="text-3xs font-semibold mb-2">Job Location</h2>
                <p className="text-gray-400">Lagos, Nigeria</p>
              </div>
            </div>
            
            <div className="flex-grow bg-white border-3 border-blue-50 space-y-8 p-4 rounded-lg w-md">
              <h2 className="text-xl font-bold mb-4">Job Overview</h2>
              <div className="grid grid-cols-3 gap-14 text-xs">
                <div>
                  <CalendarIcon className="size-10 mb-1 stroke-blue-600" />
                  <p className="text-gray-400">JOB POSTED:</p>
                  <p className="font-semibold text-gray-700">{job.postedDate}</p>
                </div>
                <div>
                  <ClockIcon className="size-10 mb-1 stroke-blue-600" />
                  <p className="text-gray-400">JOB EXPIRE IN:</p>
                  <p className="font-semibold text-gray-700">{job.expiryDate}</p>
                </div>
                <div>
                  <SquareStackIcon className="size-10 mb-1 stroke-blue-600" />
                  <p className="text-gray-400">JOB LEVEL:</p>
                  <p className="font-semibold text-gray-700">{job.jobLevel}</p>
                </div>
                <div>
                  <BriefcaseIcon className="size-10 mb-1 stroke-blue-600" />
                  <p className="text-gray-400">EXPERIENCE</p>
                  <p className="font-semibold text-gray-700">{job.experience}</p> {/* Note: Update to match actual experience if needed */}
                </div>
                <div>
                  <WalletIcon className="size-10 mb-1 stroke-blue-600" />
                  <p className="text-gray-400">EDUCATION</p>
                  <p className="font-semibold text-gray-700">{job.education}</p>
                </div>
              </div>
              <div className="bg-white border-t-2 border-gray-200 p-4 w-full flex-1">
                <h2 className="text-lg font-semibold mb-4">Share this job:</h2>
                <div className="flex space-x-4 items-center">
                  <button className="bg-blue-100 p-2 rounded text-blue-600 font-semibold items-center flex flex-col"><LinkIcon className="size-6 h-5 w-auto stroke-blue-600 stroke-2" /> <span>Copy Links</span></button>
                  <button className="bg-blue-100 size-12 items-center p-3 rounded"><LinkedInIcon className="size-6 fill-blue-700" /></button>
                  <button className="bg-blue-100 size-12 items-center p-3 rounded"><FacebookIcon className="size-6 fill-blue-700" /></button>
                  <button className="bg-blue-100 size-12 items-center p-3 rounded"><TwitterIcon className="size-6 fill-blue-700" /></button>
                  <button className="bg-blue-100 size-12 items-center p-3 rounded"><MailIcon className="size-6 stroke-2 stroke-blue-700" /></button>
                </div>
              </div>
            </div>
          </div>
