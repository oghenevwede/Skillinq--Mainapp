    ...
    <div className="bg-white">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-12 py-20">
        <div className="flex flex-col ml-10 border-b border-gray-300 pb-6 mb-6">
          <h1 className="text-3xl font-semibold mb-6">Create a Profile</h1>
        ...
        <form className="flex flex-col gap-6 max-w-3xl">
          ...
          <div className="flex flex-1 flex-row gap-80">
            <div className="ml-10">
              <span >Current Place of Employment</span>
            </div>
            <div className="flex flex-col gap-4">
              <label htmlFor="fullName" className="">Full Name</label>
              <input 
          ...
          <div className="flex flex-1 flex-row gap-80">
            <div className="ml-10">
              <span >Where can people find you online?</span>
            </div>
            <div className="flex flex-col gap-4">
              <label htmlFor="fullName" className="">Full Name</label>
              <input 
          ...
          <div className="flex flex-1 flex-row gap-80">
            <div className="ml-10">
              <span >You can update your resume</span>
              <Link className="text underline text-blue-600 font-semibold" href={'#'}>(click to view out advised resume format)</Link>
            </div>
            <div className="flex flex-col gap-4">
              <label htmlFor="fullName" className="">Full Name</label>
              <input 
