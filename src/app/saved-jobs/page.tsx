          ...
          <div className="flex flex-col gap-4 w-full">
            ...
            <div className="bg-white rounded-sm shadow p-2.5 flex flex-col lg:flex-row items-center justify-between max-w-full mx-auto space-y-2 lg:space-y-0 lg:space-x-4 border border-gray-200">
              ...
              <div className="flex items-center w-full lg:w-1/4 space-x-2">
                <button className="flex-grow flex items-center justify-center w-full rounded bg-gray-100 dark:bg-gray-700 text-gray-700 dark:text-gray-300 font-medium py-3 hover:bg-gray-200 dark:hover:bg-gray-600 transition-colors">
                  <FilterIcon className="size-6" />
                  <span>Filters</span>
                </button>
                <button
                  className="flex-grow bg-blue-900 w-full text-white font-medium py-3 rounded-lg p-4 hover:bg-blue-800 transition-colors"
